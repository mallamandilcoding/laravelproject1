        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ !empty($adminData->profile_img)? url('upload_image/admin/'.$adminData->profile_img):
                    url('upload_image/no_image.jpg') }}" alt="Header Avatar">
